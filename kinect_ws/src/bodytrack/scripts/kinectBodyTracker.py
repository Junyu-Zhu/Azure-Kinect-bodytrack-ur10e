...
class kinectBodyTracker:
    ...
    def draw2DSkeleton(self, skeleton2D, bodyId, image):
        ...
        for joint in skeleton2D.joints2D:
            ...
            x1 = int(skeleton2D.joints2D[13].position.v[0])
            y1 = int(skeleton2D.joints2D[13].position.v[1])
            x2 = int(skeleton2D.joints2D[14].position.v[0])
            y2 = int(skeleton2D.joints2D[14].position.v[1])
            image = cv2.circle(image, (x1, y1), 3, (0, 0, 255), 20)
            image = cv2.circle(image, (x2, y2), 3, (0, 0, 255), 20)
        for segmentId in range(len(_k4abt.K4ABT_SEGMENT_PAIRS)):
            ...
            point3 = skeleton2D.joints2D[_k4abt.K4ABT_SEGMENT_PAIRS[13][0]].position.v
            point4 = skeleton2D.joints2D[_k4abt.K4ABT_SEGMENT_PAIRS[13][1]].position.v
            image = cv2.line(
                image, (int(point3[0]), int(point3[1])), (int(point4[0]), int(point4[1])),
                (0, 0, 255), 4
            )
    ...
    #     print(f"BodyId: {body.id}", f"X: {body.skeleton.joints[_k4abt.K4ABT_JOINT_SPINE_NAVEL].position.v[0]:.2f} mm",
    ...
    def BodyPosition(self, body):
        return body.skeleton.joints[_k4abt.K4ABT_JOINT_SHOULDER_RIGHT].position.v[0], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_SHOULDER_RIGHT].position.v[1], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_SHOULDER_RIGHT].position.v[2], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_ELBOW_RIGHT].position.v[0], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_ELBOW_RIGHT].position.v[1], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_ELBOW_RIGHT].position.v[2], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_WRIST_RIGHT].position.v[0], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_WRIST_RIGHT].position.v[1], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_WRIST_RIGHT].position.v[2], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_HAND_RIGHT].position.v[0], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_HAND_RIGHT].position.v[1], \
               body.skeleton.joints[_k4abt.K4ABT_JOINT_HAND_RIGHT].position.v[2],
